                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Credit Card Number', // Text "Card Number"
                          style: TextStyle(
                            fontSize: 14.0,
                            color: Colors.white,
                          ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10.0),
                        Row(
                          // Add a Row to hold both expiry date and CVV input fields
                          children: [
                            Expanded(
                              // Expands to fit the available space
                              child: RectangleWidget(
                                child: Padding(
                            ...
                            SizedBox(
                                width:
                                    30.0), // Add spacing between the input fields
                            Expanded(
                              // Expands to fit the available space
                              child: RectangleWidget(
                                child: Padding(
